  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`flex h-12 shrink-0 items-center gap-3 border-b border-border transition-colors hover:bg-accent/30 ${
