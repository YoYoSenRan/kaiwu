...
1. ##### Configuration of the update the service address and update information script:
   ...
   For more information, please refer to : [electron-builder.json5...](https://github.com/YoYoSenRan/electron-vite-react/blob/2f2880a9f19de50ff14a0785b32a4d5427477e55/electron-builder.json5#L38)
...
2. ##### The update logic of Electron:
   ...
   For more information, please refer to : [update...](https://github.com/YoYoSenRan/electron-vite-react/blob/main/electron/main/update.ts)
...
3. ##### Updating UI pages in Electron:
   ...
   For more information, please refer to : [components/update...](https://github.com/YoYoSenRan/electron-vite-react/blob/main/src/components/update/index.tsx)
