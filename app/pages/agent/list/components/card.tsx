    ...
    >
      <CardContent className="flex flex-col flex-1 p-4">
        <div className="flex items-start gap-3">
          <div
            className={cn(
              "flex size-14 shrink-0 items-center justify-center overflow-hidden rounded-2xl",
          ...
          <div className="min-w-0 flex-1 space-y-1">
            ...
            {modelPrimary && (
              <Badge variant="secondary" className="h-5 px-1.5 py-0 text-[11px] font-normal gap-0.5">
