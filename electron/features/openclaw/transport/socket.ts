 ...
 * 帧内容语义不在这里——RPC 匹配走 caller.ts,事件路由走 stream.ts。
 */

import WebSocket from "ws"
import { scope } from "../../../infra/logger"
import type { ConnectChallenge, InboundFrame, RequestFrame } from "../gateway/contract"
import { buildConnectParams } from "../gateway/handshake"
import { cacheDeviceToken } from "../gateway/auth"
import type { HelloOk } from "../gateway/contract"
