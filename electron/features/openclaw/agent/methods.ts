 ...
 * 调用端：`listAgents(gateway.getCaller())`。
 */
...
export function listAgents(caller: GatewayCaller): Promise<AgentsListResult> {
 ...
 */
export function createAgent(caller: GatewayCaller, params: AgentsCreateParams): Promise<AgentsCreateResult> {
 ...
 */
export function updateAgent(caller: GatewayCaller, params: AgentsUpdateParams): Promise<AgentsUpdateResult> {
 ...
 */
export function deleteAgent(caller: GatewayCaller, params: AgentsDeleteParams): Promise<AgentsDeleteResult> {
  return caller.call("agents.delete", params) as Promise<AgentsDeleteResult>
}

/** 获取可选模型清单。入参为空对象。 */
export function listModels(caller: GatewayCaller): Promise<ModelsListResult> {
