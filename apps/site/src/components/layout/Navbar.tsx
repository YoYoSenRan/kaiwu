  ...
  return (
    ...
    >
      <nav className="mx-auto max-w-7xl h-full px-6 lg:px-8 flex items-center justify-between">
        ...
        <Link
          href="/"
          className="font-display text-xl font-700 tracking-[0.1em] text-foreground hover:text-cinnabar t-fast"
        >
          开物局
        </Link>
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "text-sm font-500 t-fast",
                  isActive
                    ? "text-foreground border-b-2 border-cinnabar pb-0.5"
        ...
        <div className="flex items-center gap-4">
          ...
          {/* 登录区 slot — s06 填充 */}
          <div className="hidden md:block" data-slot="auth" />
