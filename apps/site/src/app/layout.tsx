  ...
  return (
    <html lang="zh-CN" className={fontMono.variable}>
      ...
      <body className="font-body">
        <Navbar user={session ? { username: session.username, avatarUrl: null } : null} loginUrl={loginUrl} />
        <main className="mx-auto max-w-7xl px-6 lg:px-8 min-h-[calc(100vh-4rem)]">{children}</main>
        <Footer />
        <LiveActivityBar />
      </body>
    </html>
